...
@Component({
  selector: 'warehouse-utility-grid',
  templateUrl: './warehouse-utility-grid.component.html',
})
export class WarehouseUtilityGridComponent implements OnInit {
  loadingGrid: boolean = false;
  loadingStatus: boolean = false;
  public tableData = new PagingModel<WarehouseUtilityModel>();
  ...
  async loadData(page = null) {
    ...
    this.tableData = await this.warehouseService.filterUtility(this.queryModel);

...
@Component({
  selector: 'warehouse-service-grid',
  templateUrl: './warehouse-service-grid.component.html',
})
export class WarehouseServiceGridComponent implements OnInit {
  loadingGrid: boolean = false;
  loadingStatus: boolean = false;
  public tableData = new PagingModel<WarehouseServiceModel>();
  ...
  async loadData(page = null) {
    ...
    this.tableData = await this.warehouseService.filterService(this.queryModel);
